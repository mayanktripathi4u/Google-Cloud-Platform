...
with open("Google-Cloud-Platform/Cloud_SDK/BigQuery_Python/schemas.yaml") as schema_file:
     config = yaml.load(schema_file, Loader=yaml.Loader)

# PROJECT_ID = os.getenv('proud-climber-421817')
PROJECT_ID = 'proud-climber-421817'
BQ_DATASET = 'streamingDataSet'
CS = storage.Client()
BQ = bigquery.Client()
